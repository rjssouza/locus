...
{
    public class InserirSessao : BaseComando<Locus.Repositorio.Entidade.Sessao>, IInserirSessao
    {
        public InserirSessao(IConexaoFactoryExecutor conexao) : base(conexao)
        {
        }
