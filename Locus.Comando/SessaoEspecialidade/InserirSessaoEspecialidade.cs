...
{
    public class InserirSessaoEspecialidade : BaseComando<Locus.Repositorio.Entidade.SessaoEspecialidade>, IInserirSessaoEspecialidade
    {
        public InserirSessaoEspecialidade(IConexaoFactoryExecutor conexao) : base(conexao)
        {
        }
